...
import LecteurDepot from "../composants/LecteurDepot";
        ...
        <ul className="flex flex-col gap-3">
          {depots.map((depot) => (
            <li
              ...
              className="flex flex-col gap-4 rounded-2xl border border-border bg-background/50 p-4 md:flex-row md:items-center"
            >
              ...
              {/* Ecouter avant de decider. Le fichier n'est PAS dans public/ : il est servi
                  par une route reservee a l'admin (voir LecteurDepot). */}
              <LecteurDepot
