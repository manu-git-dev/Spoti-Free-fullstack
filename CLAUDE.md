...
démarre les serveurs, joue les 170 tests, compile le build et vérifie `npm audit`.
...
`cd tests && npm install && npm test` — **170 tests** contre l'application réellement démarrée
