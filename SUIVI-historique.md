# Suivi du projet — archive

Récaps des chantiers **terminés**, retirés de `SUIVI-PROJET.md` pour qu'il reste court (il ne
garde que ce qui attend une décision ou du travail). Rien d'actif ici : c'est la trace détaillée
de la démarche (décisions de design, bugs trouvés et corrigés), complémentaire des commits Git et
de `NOTES-APPRENTISSAGE.md`.
