...
| **Tests** | Playwright, 157 tests (parcours, sécurité, dépôt, administration) |
| **CI** | GitHub Actions — base reconstruite de zéro, 157 tests, build, `npm audit` |
...
**157 tests**, joués contre l'application réellement démarrée (base + backend + navigateur) :
...
il reconstruit la base à partir des seuls fichiers versionnés, démarre les serveurs, joue les 157
