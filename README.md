...
| **Tests** | Playwright, 152 tests (parcours, sécurité, dépôt, administration) |
| **CI** | GitHub Actions — base reconstruite de zéro, 152 tests, build, `npm audit` |
...
**152 tests**, joués contre l'application réellement démarrée (base + backend + navigateur) :
...
il reconstruit la base à partir des seuls fichiers versionnés, démarre les serveurs, joue les 152
